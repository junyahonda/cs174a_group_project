...
//          context.globals.graphics_state.camera_transform = Mat4.look_at( Vec.of( 0, -20, 15 ), Vec.of( 0,0,0 ), Vec.of( 0,10, 0 ) );
        ...
        this.materials =     
          { pond:          context.get_instance( Phong_Shader ).material( Color.of( 50/300, 255/300, 50/300, .5), { ambient: .3} ),
            ...
            shadow:         context.get_instance(Shadow_Shader).material( Color.of( 0, 0, 0, 1 ), { ambient: 0, texture: this.texture } ),
            ...
            king_Fish:      context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/car.png", false ) } ),
            mystery_Fish:   context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/car.png", false ) } ),
            plain_Fish:     context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/car.png", false ) } ),
            small_Fry:      context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/car.png", false ) } ),
            touchy_Fish:    context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/car.png", false ) } ),
            nibbler:        context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/car.png", false ) } ),
            ...
            car: context.get_instance( Phong_Shader ).material( Color.of(0.1,0.1,0,1), { ambient: .6, texture: context.get_instance( "assets/car.png", false ) } ),

            race_track:    context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/track.png", false ) } ),
        }
